...
def preprocess_data():
    data = pd.read_csv('fer2013.csv') #csvformat => emotion,pixels,Usage
    labels = pd.read_csv('fer2013new.csv') #csvformat => Usage,Image name,neutral,happiness,surprise,sadness,anger,disgust,fear,contempt,unknown,NF
